...
Silence start and end timestamp detectionJSON-based output
...
Calculate RMS (Root Mean Square) energy values.
Identify silent frames using an amplitude threshold.
Measure continuous silence duration.
Compare duration with the configured threshold.
